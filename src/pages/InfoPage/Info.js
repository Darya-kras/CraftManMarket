    ...
    return ( 
        <div className="base">
            <div className="content">
                <h1 className="header"><div className="s">~</div>Мы создаём уникальное<div className="s">~</div></h1>
                <div className="downnhead">

                    Изготовление индивидуальных сувениров специально для <span className="red">ВАС</span>! 
                    Оригинальные подарки и мерч по любимым фандомам для радости сердца и глаз :)
                </div>
            </div>
            <div className="blocks">
                <div className="block">
                <div className="headlainer">
                        <h3 className="exhead">Мы — небольшая команда, увлечённая созданием <span className="red">прекрасного</span>.</h3>
                        Наш коллектив изготавливает качественные значки, брелки, магниты, стенды, карты и блокноты из фанеры, 
                        пластика, металла и оргстекла. Мы переводим желаемое изображение 
                        в вектор и наносим его лазерной гравировокой, что обеспечивает чёткость и надёжность!
                </div>
                
                <img className="ph" src={`${process.env.PUBLIC_URL}/img/0.jpg`} alt="фото хуйнушки" />
            
                </div>
                <div className="block">
                <div className="headlainer2">
                        Хочешь увидеть свой рисунок в виде брелка?<br></br>
                        Нету сувениров по вашим любимым произведениям?<br></br> 
                        А может, нужно подарить подруге блокнот/скечбук с уникальной гравировкой?<br></br>
                        <h3 className="red">ТЫ ПО АДРЕССУ!</h3>
                </div>
                </div>
                <h1 className="arrow">↓</h1>
                <ul className="socialpoint">
                    ~
