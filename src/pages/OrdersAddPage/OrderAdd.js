...
const OrderAdd = () => {
    ...
    const handleSubmit = async  (e) => {
        ...
        setIsSending(true);
        try {
            const response = await fetch('https://egorcraftman.ru/php_backend/send_to_telegram.php', {
                method: 'POST',
                body: formData
                });
        ...
        const orderData = { id: Date.now(), category, size, material, quantity, totalCost: cost, additionalInfo, telNum };
    ...
    return (
        <div className="all">
            ...
            <div className="head">
                ...
                <span className="span">
                    После отправки формы с вами свяжется мастер для подтверждения заказа, выбора способа доставки и оплаты.
                    Если в категориях желаемого изделия не нашлось, вы можете описать идею в разделе "дополнительно".
                </span>
            </div>
            <div className="order">
                ...
                <div className="form">
                    ...
                    <div className="details">
                        <textarea id="discription" name="dis" onChange={(e) => setAdditionalInfo(e.target.value)}
                                rows={4}
                                cols={50}
                        ...
                        <input className="inputphoto" type="file" accept="image/jpeg, image/png" name="photo" onChange={handleFileChange}></input>
                    ...
                    <p>Ориентировочная стоимость:  {cost}  ₽</p> 
